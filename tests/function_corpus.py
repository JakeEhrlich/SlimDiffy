...
dog_elementwise_tests = [
    ...
    TestFunc(tensor_courpus_min_max, dog_general_strategy()),
    TestFunc(tensor_courpus_max_min, dog_general_strategy()),
    TestFunc(tensor_courpus_sin_cos, dog_general_strategy()),
    TestFunc(tensor_courpus_cos_sin, dog_general_strategy()),
    TestFunc(tensor_courpus_exp_log, dog_general_strategy()),
    TestFunc(tensor_courpus_log_exp, dog_general_strategy()),
